...
namespace HockeyRinkAPI.Migrations
{
    ...
    [Migration("20260331180129_AddGoaliePriceToSession")]
    partial class AddGoaliePriceToSession
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HockeyRinkAPI.Models.ApplicationUser", b =>
                {
                    ...
                    b.Property<string>("HockeyRegistrationNumber")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("HockeyRegistrationType")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("HockeyRinkAPI.Models.Game", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("RinkId", "GameDate");

                    b.HasIndex("SessionId", "GameDate");
            ...
            modelBuilder.Entity("HockeyRinkAPI.Models.Rink", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HockeyRinkAPI.Models.RinkBlockout", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("RinkId", "StartDateTime");

                    b.ToTable("RinkBlockouts");
                });
            ...
            modelBuilder.Entity("HockeyRinkAPI.Models.Session", b =>
                {
                    ...
                    b.Property<bool>("DraftPublished")
                        .HasColumnType("bit");
                    ...
                    b.Property<decimal?>("GoaliePrice")
                    ...
                    b.Property<int?>("RegularSeasonGames")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HockeyRinkAPI.Models.Game", b =>
                {
                    b.HasOne("HockeyRinkAPI.Models.Team", "AwayTeam")
                        .WithMany()
                        .HasForeignKey("AwayTeamId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("HockeyRinkAPI.Models.Team", "HomeTeam")
                        .WithMany()
                        .HasForeignKey("HomeTeamId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("HockeyRinkAPI.Models.Rink", "Rink")
                        .WithMany("Games")
                        .HasForeignKey("RinkId")
